...
public class Explorer1 {
    ...
    public static long TRUNCATE_VALUE(long value, int bits) {
        return ((value) & ((1L << (bits)) - 1));
    }

    // Bit sequences used to represent literal bytes
     static final short[] ChCode =
            {
